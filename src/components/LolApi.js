...
const LolApi = () => {
  ...
  return (
    ...
    >
      ...
      {loading && (
        <div className="flex justify-center items-center text-white text-xl py-4">
          Loading...
        </div>
      )}
      {error && (
        <div className="flex justify-center items-center text-red-500 text-xl py-4">
          Error: {error}
        </div>
      )}
      ...
      <div className="flex justify-center items-center text-center flex-wrap gap-4 p-4">
        {filteredChampions.length > 0 ? (
          ...
          <div className="flex justify-center items-center text-white text-lg py-4">
            No champions found
          </div>
        )}
      </div>
